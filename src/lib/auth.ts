...
// // } else {
// //   console.log("✅ BACKEND_URL:", process.env.GOOGLE_CLIENT_ID);
// // }
...
//   pages: {
//     signIn: '/login',
//     newUser: '/register', // Página para registro manual si quieres
//     error: 'auth/error', 
//   },
...
export const authOptions: NextAuthOptions = {
  ...
  pages: {
    signIn: '/login',
    // landing:'/'
    // signIn: '/auth/signin', // si la tienes
    error: '/auth/error',
    // home:'/'
  },
  ...
  callbacks: {
    ...
    async jwt({ token, user }) {
      ...
      console.log(token)
      // let cookieStore = await cookies()
      // cookieStore.set('access_token', token, { path: '/', httpOnly: true, sameSite: 'lax' })
      // cookieStore.set('refresh_token', token, { path: '/', httpOnly: true, sameSite: 'lax' })
